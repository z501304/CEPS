...
IGuiPage
{
	...
	IGuiDiagnosticView
	{
		...
		qm_diagViewToolbarPosY: 327
		qm_diagViewToolbarWidth: 778
			...
			Component
			{
				IGuiListCtrl
				{
					...
					IGuiListColumnView
					{
						...
						height: 266
						columnType: 1
						qm_columnValueVarTextAlignmentHorizontal: Image.AlignLeft
						qm_columnValueVarTextAlignmentVertical: Image.AlignVCenter
					}
					IGuiListColumnView
					{
						id: qc2ffffffff
